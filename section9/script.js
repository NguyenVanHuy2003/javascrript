...
document.querySelector('button').addEventListener('click', function (){
    ...
    for (const [i, row] of rows.entries()) {
        const [first, scond] = row.toLowerCase().trim().split('_');
...
console.log(announcement.replace(/doorg/g, 'gate'));
...
/*
/////////////////////////////
// Looping Objects: Obiect keys, Values, and Entries
// Property NAMES
